...
//
// PRIVATE HELPER FUNCTIONS for the PriorityQueue class:
//   void printlist()
//     Postcondition: Prints out all data values of the PriorityQueue
//
//   void clear()
//     Postcondition: Deallocates memory used by the PriorityQueue and returns it
//     to the heap.
//
...
namespace coen70_lab8 { 
    ...
    public:
        ...
        Item get_front();
        bool is_empty() const {
            return (head_ptr == NULL && many_nodes == 0);
        }
